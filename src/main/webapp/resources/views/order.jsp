        ...
        <div class="d-flex justify-content-between">
          ...
          <div>
            ...
            <select id="direction" name="direction" onchange="changeDirection()">
              <option value="ASC" ${direction.equals("ASC")?'selected':''}>Date Created ASC</option>
              <option value="DESC" ${direction.equals("DESC")?'selected':''}>Date Created DSC</option>
            </select>
          </div>
        </div>
        <!-- table -->
          ...
          <div class="col-lg-12">
            <div class="card easion-card">
              <div class="card-header">
                ...
                <div class="easion-card-title">Order</div>
              </div>
              <div class="card-body">
                    ...
                    <tr>
                      ...
                      <td>
                        <button
                                ...
                                id="model-button"
                        >
                          <a href="<%=request.getContextPath()%>/orderController/findAll?id=${order.orderId}"
                          ><span class="badge badge-pill badge-warning"
                          >Approve</span
                          ></a
                          >
                        </button>
                        <a href="<%=request.getContextPath()%>/orderController/delete?id=${order.orderId}"
          ...
          >
            <c:forEach items="${listPages}" var="page">
              <button type="button" class="btn btn-secondary"  >
                <a href="<%=request.getContextPath()%>/orderController/findAll?page=${page}"  class="text-light">${page}</a>
              </button>
            </c:forEach>
          </div>
