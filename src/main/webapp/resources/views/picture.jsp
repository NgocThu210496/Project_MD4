...
<div class="dash">
  <div class="dash-nav dash-nav-dark">
    <header>
      ...
      <a href="d<%=request.getContextPath()%>/dashboardController/findAll" class="easion-logo"
        ...
        <div class="d-flex justify-content-between">
          ...
          <div>
            ...
            <select id="direction" name="direction" onchange="changeDirection()">
              <option value="ASC" ${direction.equals("ASC")?'selected':''}>Image Id ASC</option>
              <option value="DESC" ${direction.equals("DESC")?'selected':''}>Image Id DSC</option>
            </select>
          </div>
        </div>
        <!-- table -->
          ...
          <div class="col-lg-12">
            <div class="card easion-card">
              <div class="card-header">
                ...
                <div class="easion-card-title">Images</div>
              </div>
              <div class="card-body">
                  ...
                  <c:forEach items="${imageList}" var="image">
                    ...
                    <tr>
                      ...
                      <td>
                          ...
                          <%--                                                    >--%>
                          <%--                                                </button>--%>
                        <a href="<%=request.getContextPath()%>/pictureController/delete?id=${image.imageId}"
          ...
          >
            <c:forEach items="${listPages}" var="page">
              <button type="button" class="btn btn-secondary">
                <a href="<%=request.getContextPath()%>/pictureController/findAll?page=${page}"
